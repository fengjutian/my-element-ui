<script>
  ...
  import ElButton from 'i-element-ui/packages/button';
  import ElButtonGroup from 'i-element-ui/packages/button-group';
  import { generateId } from 'i-element-ui/src/utils/util';
