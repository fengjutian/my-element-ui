...
<script>
import Popper from 'i-element-ui/src/utils/vue-popper';
import Clickoutside from 'i-element-ui/src/utils/clickoutside';
import Emitter from 'i-element-ui/src/mixins/emitter';
import Locale from 'i-element-ui/src/mixins/locale';
import Migrating from 'i-element-ui/src/mixins/migrating';
import ElInput from 'i-element-ui/packages/input';
import ElTag from 'i-element-ui/packages/tag';
import ElScrollbar from 'i-element-ui/packages/scrollbar';
import ElCascaderPanel from 'i-element-ui/packages/cascader-panel';
import AriaUtils from 'i-element-ui/src/utils/aria-utils';
import { t } from 'i-element-ui/src/locale';
import { isEqual, isEmpty, kebabCase } from 'i-element-ui/src/utils/util';
import { isUndefined, isFunction } from 'i-element-ui/src/utils/types';
import { isDef } from 'i-element-ui/src/utils/shared';
import { addResizeListener, removeResizeListener } from 'i-element-ui/src/utils/resize-event';
